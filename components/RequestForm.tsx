...
function RequestModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end bg-black/70 backdrop-blur-sm">
      <div
        className={`mx-auto max-h-[92vh] w-full max-w-md overflow-y-auto rounded-t-3xl border-t p-5 shadow-2xl ${
          isUrgent
            ? "border-red-300/30 bg-[#111827]"
            : "border-[#c9a86a]/20 bg-[#111827]"
        }`}
      >
